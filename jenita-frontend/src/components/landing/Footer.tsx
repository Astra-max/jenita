const cols = [
  ...
  { heading: "Company", links: ["Blog", "Support", "About"] },
...
export function Footer() {
  return (
    <footer className="bg-white border-t border-pink-200 pt-12 sm:pt-16 pb-10">
      <div className="max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-10">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 sm:col-span-1">
            <span className="text-2xl font-bold text-black block mb-4 tracking-tight">
              Jenita
            </span>
            <div className="flex gap-2">
              {socialIcons.map((ic) => (
                <button
                  key={ic.label}
                  aria-label={ic.label}
                  className="w-10 h-10 flex items-center justify-center rounded-md hover:bg-pink-50 transition-colors"
                >
          ...
          {cols.map((col) => (
            <div key={col.heading}>
              <p className="text-base font-medium text-black mb-5">{col.heading}</p>
              <ul className="flex flex-col gap-3">
                {col.links.map((l) => (
                  <li key={l}>
                    <a href="#" className="text-[15px] text-[#454545] hover:text-black transition-colors">
                      {l}
                    </a>
                  </li>
                ))}
        ...
        <div className="border-t border-pink-200 pt-6">
          <p className="text-sm text-[#828282]">© 2026 Jenita. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
